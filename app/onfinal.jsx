    ...
    `);
        ...
        {isLandscape ? (
          ...
          >
            ...
            <WebView
              ...
              originWhitelist={['*']}
              source={{
                html: htmlContent(pages, 0, scrollMode, isSpreadMode, fontFamily, fontSize)
              }}
      ...
      `);
              ...
              onMessage={(event) => {
                ...
                if (msg.type === "PAGE_POSITIONS") {
                  ...
                  // console.log("Page positions:", positions)
                ...
                if (msg.type === 'DOUBLE_TAP') {
                  ...
                  if (nextFullscreen) {
                    // ১. ল্যান্ডস্কেপ লক করা
                    ScreenOrientation.lockAsync(ScreenOrientation.OrientationLock.LANDSCAPE);

                    // ২. নিচের নেভিগেশন বার হাইড করা (অ্যান্ড্রয়েড)
                    NavigationBar.setVisibilityAsync("hidden");

                    // ৩. বাটনগুলো এমনভাবে সেট করা যাতে সোয়াইপ করলে সাময়িক দেখা যায় (Sticky behavior)
                    NavigationBar.setBehaviorAsync("sticky-swipe");
                    ...
                    // ২. নেভিগেশন বার আবার ফিরিয়ে আনা
                    NavigationBar.setVisibilityAsync("visible");
      ...
      {floatingVisible && (
        <View style={[styles.contextMenu, {
          top: Math.max(10, floatingPos.y - 120),
          ...
          {actionMode === 'delete' && (
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                const found = notes.find(n => n.ref?.text === selectedText);
